...
ScrollReveal().reveal('.home__img, .about__img, #coltwo' , {origin: 'right'});

ScrollReveal().reveal('.home__data, .about__description, .portfolio__container, .contact__container, #colone' , {origin: 'left'});
